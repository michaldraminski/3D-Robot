...
public class Robot3D extends JFrame implements ActionListener, KeyListener{
    ...
    BranchGroup utworzScene(){
        ...
        Alpha alpha_animacja = new Alpha(-1,000);
        ...
        trans_walca3.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
        ...
        przesuniecie_walca3.set(new Vector3f(0f,0.05f,0.0f));
        ...
        trans_walca3.addChild(walec2);
        obrot_animacja.addChild(trans_walca3);
